...
## Otimização
#### A otimização foi realizada por superfieciede resposta, apesar de poder ser contruidida com o modelo1, par uma melhor visulaização, foi criado o modelo2 agora com os valores nas variaveis em vez dos niveis.
